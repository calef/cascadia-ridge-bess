...
**Fire risk.** EPRI tracks two failure metrics for lithium-ion BESS. Their per-project rate (0.3%/yr) puts the 30-year compound probability at **roughly 9%**. Their per-GW rate, which accounts for facility size, puts a 130 MW facility at **3.9% per year, compounding to 70% over 30 years.** [Full analysis.](/fire-risk)
