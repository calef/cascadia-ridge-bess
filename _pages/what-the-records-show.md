---
title: "What King County's Records Show"
---
...
The no-fire scoping is also internally inconsistent with the rest of the application. The applicant is planning on-site stored water plus a nearby hydrant for fire suppression, has initiated coordination with Eastside Fire & Rescue, and has identified the body of public studies on contamination from containerized BESS fires as the relevant evidentiary record. Each of those steps presupposes a credible fire scenario at the facility. A consequence analysis that excludes fire from the modeled outcome cannot be reconciled with operational planning that treats fire as the event to prepare for.
...
For the procedural context of the SEPA window and how to write a substantive comment, see [Permitting Status](/permitting) and [How to Write an Effective SEPA Comment](/sepa-comments).
