...
Jupiter Power provides a project email address (cascadiaridge@jupiterpower.io). On April 1, 2026, after three emails and two weeks of silence, Jupiter Power responded to a single question (fire risk) out of 16 submitted. The response included generic fire code compliance language and the statement that battery chemistry "has not yet been selected" but is expected to be "lithium ion (LFP) or sodium ion." The remaining 15 questions on setbacks, noise, the canceled permit, stormwater, air dispersion, decommissioning, financial assurance, parcels, the Accelergen relationship, critical areas, floodplain, and wildlife surveys were deferred to "the final application materials." Jupiter Power committed that "all project design, environmental diligence studies, and decommissioning plans will be made public during the SEPA checklist review."
