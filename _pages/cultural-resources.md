...
Before its board approved the tolling agreement for this project, PSE conducted due diligence and put the results in the [record of its 2026 rate case](https://apiproxy.utc.wa.gov/cases/GetDocument?docID=1400&year=2026&docketNumber=260005). PSE's own report says, verbatim, that the developer's cultural resources review:
...
- Produce the Cultural Resources Inventory the applicant already cites, plus a records search or assessment prepared by a qualified professional archaeologist
- Document government-to-government consultation with the Snoqualmie Indian Tribe in the SEPA record before any threshold determination
- Add the Washington Department of Archaeology and Historic Preservation to the agencies notified of the application
- Treat the missing professional cultural assessment as a record gap that must be resolved before the County can issue a Determination of Non-Significance
