...
|---|---|---|---|---|
| 3624079039 | ~25.4 | Snoqualmie 55 LLC | UR | Purchase agreement (Jan 2024), 5-year due diligence |
| 3624079093 | ~5.0 | Nause LLC | UR | Option to purchase (Mar 2024). Vacant, transmission line easement. Not in original permit application. |
...
The Snoqualmie Indian Tribe owns a nearby parcel ([3624079104](https://blue.kingcounty.com/Assessor/eRealProperty/Dashboard.aspx?ParcelNbr=3624079104), ~15.8 ac) but it is not adjacent to the project parcels and has no recorded Jupiter Power agreement.

## Construction access {#construction-access}

The only road access to the project parcels from a public road runs through the PSE transmission corridor, crossing all five PSE corridor parcels (9099, 9098, 9102, 9091, 9030). The Pre-Annexation Development Agreement and perpetual Covenant impose overlapping restrictions on these parcels that limit them to transmission line operations: parcels 9098 and 9099 are restricted to transmission line construction, parcel 9102 requires a full Annexation Implementation Plan before any development, and the 12.95-acre Vegetation Maintenance Area requires prior written city approval for any vegetation alteration. Jupiter Power cannot route BESS construction traffic through this corridor without the City of Snoqualmie's approval. See the [full analysis on the recorded documents page](/recorded-documents/#access-road).
