...
There are two potential road access routes to the project parcels, neither designed for industrial construction traffic. One runs through the PSE transmission corridor (all five PSE corridor parcels), where the PADA and Covenant impose restrictions limiting use to transmission line operations. The other follows a private residential road east through Short Plat 775062 parcels to 364th Ave SE, using a road easement referenced in parcel 9039's legal description. The scope of that easement, and whether it permits construction traffic for a 130 MW battery storage facility, depends on the terms of the original instrument. See the [full analysis on the recorded documents page](/recorded-documents/#access-road).
