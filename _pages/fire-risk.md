...
- **Internal cell damage.** Lab testing shows lithium-ion cells can develop internal short circuits — the initiating event for thermal runaway — from [as little as 4mm of axial compression](https://www.sciencedirect.com/science/article/abs/pii/S0378775314007708). Even low-magnitude earthquakes (M2–3) can produce mechanical forces in that range. The faults threatening the Snoqualmie Valley are capable of M6.5–7.5. No study has tested this specific chain at utility scale, but IEEE 693 is designed to keep equipment on its mounts — not to prevent the kind of vibration and shock that damages cells internally.
