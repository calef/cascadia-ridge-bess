...
**The developer already has a sodium-ion contract.** In November 2025 Jupiter Power announced a [sodium-ion supply agreement with Peak Energy](https://www.prnewswire.com/news-releases/peak-energy-signs-4-75-gwh-contract-with-jupiter-power-for-industry-leading-sodium-ion-battery-storage-systems-302612467.html) covering up to 4.75 GWh, which the parties said could be worth more than $500 million. A full EIS alternatives analysis would force that choice onto the record: why is a chemistry with thermal runaway risk being proposed at a site adjacent to thousands of homes when the developer has contracted at that scale for an alternative?
