...
Jupiter Power's clearing-and-grading application (GRDE26-0036, filed May 6, 2026) triggers environmental review under the State Environmental Policy Act (SEPA). When King County accepts the application as complete, it publishes a Notice of Application and opens a **14-day public comment window**. At the close of that window, King County issues a threshold determination (DNS, MDNS, or DS). There is no public hearing and no further comment period after the determination -- if King County issues a DNS over the community's objections, the only recourse is a court appeal. This is the primary formal opportunity for public input on this project. If you want your concerns on the record, this is the moment.
...
### B.3 Water
Fisher Creek (Type F, fish-bearing) runs through the northwest portion of the primary parcel. Contaminated fire suppression runoff (heavy metals, fluoride compounds) would drain directly into the creek and from there into the Snoqualmie River watershed. Groundwater is a separate concern: the surrounding homes depend entirely on private wells with no municipal backup, the applicant's own Phase I site assessment counts 13 wells on the property itself, and no site-specific hydrogeological assessment of groundwater flow or contaminant migration has been submitted. See our [site and environment analysis](/site-and-environment) and the detail on [private wells and groundwater](/site-and-environment#groundwater).

### B.4 Plants / B.5 Animals
ESA-listed Chinook salmon (threatened, 1999), steelhead (threatened, 2007), and bull trout (threatened, 1999) are documented in the Snoqualmie River below Snoqualmie Falls, downstream of where the site's drainage enters the river. The Critical Areas Designation identified potential Vaux's swift nesting habitat and western toad on the site. The project would clear roughly 30 acres of mature conifer forest, potential nesting habitat for the federally threatened marbled murrelet, with no habitat-suitability survey, even though the applicant's own tolling agreement names murrelet habitat as a site concern. See our [wildlife and habitat analysis](/site-and-environment#wildlife-and-habitat).
...
### B.9 Noise
A 130 MW BESS runs its cooling and inverter systems continuously. The applicant's own Sound Study predicts the closest home at most 3 dBA under the nighttime limit, and at zero margin against the stricter limit it applied, but it uses substitute sound data for three of the four equipment types, models equipment the applicant has not selected, measured no nighttime baseline at the affected homes, and leaves out the adjacent Mt. Si substation as a combined noise source. A prediction this close to the limit on placeholder inputs does not demonstrate the built facility will comply. See our [noise analysis](/noise).

### B.10 Aesthetics / B.11 Light and glare
The applicant's visual simulations model views from Snoqualmie Parkway rather than from the ridge homes that overlook the site, and no complete light-trespass or photometric analysis has been done at the adjacent property lines for the 30-foot, 12,096-lumen fixtures the site plan specifies. A continuously lit industrial facility a few hundred feet from homes is a built-environment impact under WAC 197-11-444. See our [visual and light impacts](/site-and-environment#visual-and-light).

### B.13 Historic and cultural preservation
The site is less than a mile from Snoqualmie Falls, a National Register Traditional Cultural Property, and within the ancestral territory of the Snoqualmie Indian Tribe, which owns a parcel in the same section and has said it will engage the review. PSE's own due diligence found the applicant's cultural review was not done by a professional archaeologist, lacks the standard statewide (WISAARD) data, involved no field work, and fails to identify Snoqualmie Falls as a Traditional Cultural Property. No tribal consultation is documented in the SEPA record. See our [cultural resources and tribal consultation](/cultural-resources).
...
[Sign up for updates](/subscribe). We'll email you the day the comment window opens with the submission address and deadline. If you want to start drafting now, pick one checklist element above where you have knowledge or experience, and write about that. Short and specific beats long and vague.

If you're a credentialed professional (physician, engineer, geologist, ecologist, financial analyst) and want to coordinate on technical comments, [contact us](mailto:chris@crickertech.com).
